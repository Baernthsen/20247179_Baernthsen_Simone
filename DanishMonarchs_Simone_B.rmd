...
separator: Comma-separator, so we have to use read.csv and read_cvs
...
# YOUR CODE
kings_new <- kings %>%
  filter(!is.na(End_year),!is.na(Start_year)) %>% 
    mutate(kings_duration=End_year-Start_year)

glimpse(kings_new$kings_duration)
```
